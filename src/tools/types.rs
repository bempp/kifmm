...
pub fn get_itemsize(dtype: DTYPE) -> usize {
    match dtype {
        DTYPE::Float32 => crate::tools::get_size::<f32>(),
        DTYPE::Float64 => crate::tools::get_size::<f64>(),
        DTYPE::Unsigned8 => crate::tools::get_size::<u8>(),
        DTYPE::Unsigned32 => crate::tools::get_size::<u32>(),
        DTYPE::Unsigned64 => crate::tools::get_size::<u64>(),
        DTYPE::Int8 => crate::tools::get_size::<i8>(),
        DTYPE::Int32 => crate::tools::get_size::<i32>(),
        DTYPE::Int64 => crate::tools::get_size::<i64>(),
        DTYPE::Usize => crate::tools::get_size::<usize>(),
    }
}
