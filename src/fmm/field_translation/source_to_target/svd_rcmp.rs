...
use crate::tree::types::single_node::SingleNodeTree;

use crate::fmm:::types::{FmmDataUniform, KiFmmLinear};
...
pub mod matrix {
    use crate::field::types::SvdFieldTranslationKiFmmRcmp;

    use crate::fmm::types::{FmmDataUniformMatrix, KiFmmLinearMatrix, SendPtrMut};
...
pub mod uniform {
    ...
    use crate::fmm::types::SendPtrMut;
