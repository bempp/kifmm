    ...
    Self: SourceToTargetTranslation + FmmOperatorData,
{
    ...
    fn multipole(
        &self,
        key: &<<Self::Tree as crate::traits::tree::SingleNodeFmmTreeTrait>::Tree as crate::traits::tree::SingleNodeTreeTrait>::Node,
    ) -> Option<&[Self::Scalar]> {
...
mod test {
    ...
    use crate::{
        ...
        traits::tree::{FmmTreeNode, SingleNodeFmmTreeTrait, SingleNodeTreeTrait},
