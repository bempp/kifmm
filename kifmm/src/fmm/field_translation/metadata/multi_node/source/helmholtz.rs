...
where
    Scalar: RlstScalar<Complex = Scalar> + Default + Epsilon + MatrixSvd + Equivalence + Epsilon,
    <Scalar as RlstScalar>::Real: Default + Sync + Send + Default + Equivalence + Float + Epsilon,
