        ...
        match self.fmm_eval_type {
            FmmEvalType::Vector => {
...

                {
                    (0..NTRANSFER_VECTORS_KIFMM)
                        ...
                        .for_each(|((c_idx, multipole_idxs), local_idxs)| {
                            ...
                            tmp2 += (compressed_multipoles_subset.data().len()) as f64;
                            ...
                            tmp2 += (m * multipole_idxs.len() * (2 * n - 1)) as f64;
                            ...
                            tmp2 += (local_idxs.len() * self.source_to_target.cutoff_rank[m2l_operator_index]) as f64;
                ...
                // 3. Compute local expansions from compressed check potentials
                {
                    ...
                    nflops += (m * n * n_targets) as f64; // Real multiplications
                    nflops += (m * n_targets * (n - 1)) as f64; // Real additions
