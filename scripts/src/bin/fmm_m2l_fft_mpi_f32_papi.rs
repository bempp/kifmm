...
use kifmm_papi_sys as papi_ffi;
use mpi::traits::*;
...
fn do_papi_init() {
    unsafe {
        ...
        let ver: c_int = papi_ffi::PAPI_library_init(papi_ffi::PAPI_VER_CURRENT);

        assert_eq!(
            ver,
            papi_ffi::PAPI_VER_CURRENT,
            "PAPI library version mismatch: got {}, expected {}",
            ver,
            papi_ffi::PAPI_VER_CURRENT
        );
    }
